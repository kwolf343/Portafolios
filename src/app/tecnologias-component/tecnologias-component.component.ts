...
export class TecnologiasComponentComponent implements OnInit{
  ...
  imagenes:string[]=['assets/html.png','assets/css.png','assets/angular.png','assets/android.png','assets/react.png','assets/springBoot.png','assets/javascript.png','assets/typescript.png','assets/csharp.png','assets/java.png','assets/sql.png','assets/mysql.png','assets/firebase.png'];
